...
<body>
    ...
    <form action="belajar_post.php" method="POST">
        ...
        <input type="checkbox" name="mata_kuliah" value="Jaringan Statis">
            <label for="">Jaringan Statis</label><br>
        <input type="checkbox" name="mata_kuliah" value="PKN">
            <label for="">PKN</label><br><br>
        <!-- tipe number -->
